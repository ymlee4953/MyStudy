...
3. **Nexus Configuration Files**
    ...
    - change value : sonatype-work → nexusdata
          ...
          sudo mv /opt/nexus/bin/nexus.vmoptions /opt/nexus/bin/nexus.vmoptions.bak

          sudo sed 's/sonatype-work/nexusdata/g' /opt/nexus/bin/nexus.vmoptions.bak > /opt/nexus/bin/nexus.vmoptions
