...
1. Declare Cluster Information
    ...
    - At the ansible Server
          ...
          export ETCD_1=10.168.40.43
          export ETCD_2=10.168.40.2
          export ETCD_3=10.168.40.32

          export LB_1=10.168.40.58

          export MASTER_1=10.168.40.59
          export MASTER_2=10.168.40.39
          export MASTER_3=10.168.40.8

          export WORKER_1=10.168.40.20
          export WORKER_2=10.168.40.30
          export WORKER_3=10.168.40.9

          export GLUSTERFS_1=10.168.40.23
          export GLUSTERFS_2=10.168.40.62
          export GLUSTERFS_3=10.168.40.18

          export HEKETI_0=10.168.40.49

          export BASTION_0=10.168.40.51
          export NEXUS_0=10.168.40.10
