...
1. Declare Cluster Information
    ...
    - At the ansible Server
          ...
          export K8S_CLUSTER_NAME=k8s_cluster_b1
          export CLUSTER_DOMAIN=b1.k8s.demo.ymlee
          export K8S_VERSION=v1.20.5
          export POD_SUBNET=192.168.0.0/16
          export SERVICE_SUBNET=20.96.0.0/16

          export ETCD_1=10.178.165.134
          export ETCD_2=10.178.165.156
          export ETCD_3=10.178.165.180

          export LB_1=10.178.165.173

          export MASTER_1=10.178.165.131
          export MASTER_2=10.178.165.149
          export MASTER_3=10.178.165.164

          export WORKER_1=10.178.165.158
          export WORKER_2=10.178.165.133
          export WORKER_3=10.178.165.170
