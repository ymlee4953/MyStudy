...
1. NFS Dynamic Storage Class 구성 (Demo 환경) 
    ...
    1.3-1 NFS Provisioning Deployment 파일 
    - nfs_provision_IBMCloud.yaml

          mkdir -p ~/configurations/master-1/

          cat <<EOF> ~/configurations/master-1/nfs_provision_IBMCloud.yaml
          kind: Deployment
          apiVersion: apps/v1
          metadata:
            name: nfs-pod-provisioner
          ...
          cat ~/configurations/master-1/nfs_provision_IBMCloud.yaml
    ...
    - Master-1
          ...
          kubectl apply -f ~/NFS/nfs_provision_IBMCloud.yaml
